...
const courseData: Section[] = [
  {
    ...
    lessons: [
      ...
      { id: "html-attributes", title: "Links & Images", completed: false },
      { id: "html-lists", title: "Lists", completed: false },
      { id: "html-forms", title: "Forms", completed: false },
      { id: "html-tables", title: "Tables", completed: false },
      { id: "html-semantic", title: "Semantic HTML", completed: false },
      { id: "html-media", title: "Media Elements", completed: false },
    ],
  },
  {
    id: "css",
    ...
    lessons: [
      ...
      { id: "css-flexbox", title: "Flexbox", completed: false },
      { id: "css-responsive", title: "Responsive Design", completed: false },
      { id: "css-typography", title: "Typography", completed: false },
      { id: "css-positioning", title: "Positioning", completed: false },
      { id: "css-grid", title: "Grid Layout", completed: false },
      { id: "css-animations", title: "Transitions & Animations", completed: false },
    ],
  },
  {
    id: "javascript",
    ...
    lessons: [
      ...
      { id: "js-arrays", title: "Arrays", completed: false },
      { id: "js-objects", title: "Objects", completed: false },
      { id: "js-conditionals", title: "Conditionals & Loops", completed: false },
      { id: "js-events", title: "Events", completed: false },
      { id: "js-es6", title: "ES6+ Features", completed: false },
      { id: "js-async", title: "Async JavaScript", completed: false },
    ],
  },
];
